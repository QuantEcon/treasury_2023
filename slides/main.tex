...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \vspace{0.5em}
        \item Google Bard uses Google JAX
        \vspace{0.5em}
        \item Apple Ajax uses Google JAX
    \end{itemize}
...
\begin{frame}
    ...
    \vspace{0.5em}
        \item $x = $ income distribution, $y = $ tax revenue
    \vspace{0.5em}
...
\begin{frame}
    ...
    \begin{equation*}
        \psi_\theta
        = A_{1} \circ \sigma \circ \cdots \circ A_{k} \circ \sigma
    \end{equation*}
    %
    where
    %
